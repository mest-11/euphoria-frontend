const Section3 = () => {
    return (
        <div className="flex flex-col justify-center items-center">
            ...
            <div class="bg-amber-400 border border-slate-200 grid grid-cols-6 gap-2 rounded-xl p-2 text-sm w-[400px] h-[250px]">
                <h1 class="text-center text-blue-950 text-xl font-bold col-span-6">Send Feedback</h1>
                ...
                <button class="bg-slate-100 stroke-slate-600 border border-slate-200 col-span-2 flex justify-center rounded-lg p-2 duration-300 hover:border-slate-600 hover:text-white focus:stroke-blue-200 focus:bg-blue-400">
                    <svg fill="none" viewBox="0 0 24 24" height="30px" width="30px" xmlns="http://www.w3.org/2000/svg" className="fill-deepBlue">
