...
const FooterSocial = () => {
    return (
        ...
        <div className="bg-black">
            ...
            <div className="flex  justify-center items-center gap-x-10 gap-y-10 pt-2 ">

                <div className="flex items-center justify-center gap-5 text-white text-[20px] font-medium antialiased"> <h2>Contact us:</h2>
                    <h3 className="underline"><a href="mailto:expertcare@expert.com">Send Email</a></h3>
                    <h3 className="underline"><a href="tel:+233501376295">Call Us</a></h3></div>
            ...
            <p class="footer-p1 flex justify-center items-center pb-5 text-white"> Copyright © 2024 Expert Care, All rights reserved.</p>
